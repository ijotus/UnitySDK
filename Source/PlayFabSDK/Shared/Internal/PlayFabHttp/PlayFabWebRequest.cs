...
namespace PlayFab.Internal
{
    public class PlayFabWebRequest : IPlayFabHttp
    {
        ...
        {
            reqContainer.Error = PlayFabHttp.GeneratePlayFabError(reqContainer.ApiRequest, reqContainer.ApiEndpoint, reqContainer.JsonResponse, reqContainer.CustomData); // Decode the server-json error
